...
class PromptManager:
    ...
    SYSTEM_PROMPTS = {
        ...
        PromptVersion.V2_1: (
            "You are a helpful AI assistant. Please answer the user's questions kindly. "
            "당신은 한국의 전통 문화와 역사, 문법, 사회, 과학기술 등 다양한 분야에 대해 잘 알고 있는 유능한 AI 어시스턴트 입니다. 사용자의 질문에 대해 친절하게 답변해주세요. "
            "키워드가 반드시 정답은 아닐 수 있습니다. 참고 문서의 출처는 적지 않아도 됩니다. 질문에 대한 답변만 답하세요. 그리고 동일한 문장을 절대 반복하지 마시오."
        ),
    ...
    TYPE_INSTRUCTIONS = {
        ...
        PromptVersion.V2_1: {
            ...
            "서술형": (
                "[지시사항] 질문을 잘 읽고 완성된 서술형으로 답변하세요. 최대한 자세히 적되, 핵심 단어와 중요한 정보를 답하여야합니다. 문제를 그대로 출력하지 마시오."
            ),
            "단답형": (
                "[지시사항] 질문을 잘 읽고 단답형으로 답하시오. 문제를 그대로 출력하지 마시오."
            )
        ...
        PromptVersion.V2_2: {
            "선다형": (
                "[지시사항] 질문을 잘 읽고 주어진 보기 중에서 정답을 숫자로만 답변하시오. 문제를 그대로 출력하지 마시오. 선다형에서는 관련 정보의 내용을 판단하는 과정을 수행해야합니다. <think>\n추론내용\n</think><answer>\n답변내용\n</answer>의 형태로 대답하세요."
            ),
            "서술형": (
                "[지시사항] 질문을 잘 읽고 완성된 서술형으로 답변하세요. 최대한 자세히 적되, 핵심 단어와 중요한 정보를 답하여야합니다. 문제를 그대로 출력하지 마시오. 서술형에서는 <think>\n\n</think><answer>\n답변내용\n</answer> 형태로 바로 대답하세요."
            ),
            "단답형": (
                "[지시사항] 질문을 잘 읽고 단답형으로 답하시오. 문제를 그대로 출력하지 마시오. 단답형에서는 바로 대답하세요. <think>\n\n</think><answer>\n답변내용\n</answer> 형태로 답하여야합니다."
            )
        }
    }
